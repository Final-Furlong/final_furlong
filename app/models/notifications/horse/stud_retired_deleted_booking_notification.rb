module Notifications::Horse
  class StudRetiredDeletedBookingNotification < ::Notification
    def message
      event = I18n.t("#{base_i18n_key}.retired")
      mare = params["mare_id"].present? ? params["mare_name"] : I18n.t("#{base_i18n_key}.open")
      I18n.t("notifications.stud_booking_auto_deleted.message", event:, sire:
        params["stud_name"], mare:)
    end

    def title
      event = I18n.t("#{base_i18n_key}.title.retired")
