...
#  thirds         :integer
#  wins           :integer
#  year           :integer          primary key, uniquely indexed => [stable_id]
#  stable_id      :bigint           primary key, uniquely indexed => [year]
#
# Indexes
#
#  index_stable_annual_race_records_on_stable_id_and_year  (stable_id,year) UNIQUE
#
