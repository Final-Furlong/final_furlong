class CreateRacehorseShipping < ActiveRecord::Migration[8.1]
  def change
    ...
    create_table :racehorse_shipments do |t|
      ...
      t.enum :mode, enum_type: :shipping_mode, index: true, comment: shipping_modes.join(", ")
      ...
      t.enum :shipping_type, enum_type: :shipping_type, index: true, comment: shipping_types.join(", ")

      t.timestamps
    end
    remove_index :racehorse_shipments, :horse_id, if_exists: true
    ...
    create_table :broodmare_shipments do |t|
      ...
      t.references :starting_location, type: :bigint, null: false, index: true, foreign_key: { to_table: :locations }
      t.references :ending_location, type: :bigint, null: false, index: true, foreign_key: { to_table: :locations }
      t.references :current_farm, type: :bigint, null: false, index: true, foreign_key: { to_table: :stables }

      t.timestamps
    end
    remove_index :broodmare_shipments, :horse_id, if_exists: true
