module Racing
  class LocationRaceRecord < ApplicationRecord
    self.table_name = "location_race_records"
    self.primary_key = :horse_id

    belongs_to :horse, class_name: "Horses::Horse", inverse_of: :location_race_records
...
# == Schema Information
#
# Table name: location_race_records
