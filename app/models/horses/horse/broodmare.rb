module Horses
  class Horse::Broodmare < Horse
    ...
    has_many :broodmare_shipments, class_name: "Horses::Broodmare::Shipment", inverse_of: :horse, dependent: :delete_all
    ...
    def last_shipment
      broodmare_shipments.includes(:ending_farm).current.order(arrival_date: :desc).first
    end
  end
end
