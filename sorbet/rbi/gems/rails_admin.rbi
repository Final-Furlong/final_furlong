...
class RailsAdmin::Version
  def self.actual_js_version; end
  def self.js; end
  def self.js_version_from_node_modules; end
  def self.to_s; end
  def self.warn_with_js_version; end
end
...
class RailsAdmin::Support::Datetime
  def self.to_flatpickr_format(strftime_format); end
end
...
module RailsAdmin::Config
  ...
  def self.asset_source; end
  def self.asset_source=(arg0); end
  ...
  def self.parent_controller=(name); end
  ...
  def self.sidescroll=(_); end
  def self.total_columns_width=(_); end
...
class RailsAdmin::Config::Fields::Types::Citext < RailsAdmin::Config::Fields::Types::Text
end
...
class RailsAdmin::CSVConverter
  def export_field_for(method, model_config = nil); end
...
class RailsAdmin::Adapters::ActiveRecord::StatementBuilder < RailsAdmin::AbstractModel::StatementBuilder
end
