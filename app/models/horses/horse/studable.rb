module Horses::Horse::Studable
  ...
  included do
    ...
    has_one :stud_options, class_name: "Horses::StallionOption", foreign_key: :stud_id, inverse_of: :stud, dependent: :delete
