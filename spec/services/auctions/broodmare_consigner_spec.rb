RSpec.describe Auctions::BroodmareConsigner do
  context "when number is 0" do
    it "returns 0 horses" do
      create(:legacy_horse, :broodmare, :final_furlong)
  ...
  context "when min age = max age" do
    it "only returns horses of that age" do
      younger = create(:legacy_horse, :broodmare, :final_furlong, DOB: Date.current - 2.years)
      older = create(:legacy_horse, :broodmare, :final_furlong, DOB: Date.current - 3.years)
  ...
  context "when stakes quality is false" do
    it "only returns non-silver/gold ranked horses" do # rubocop:disable RSpec/ExampleLength
      unranked = create(:legacy_horse, :broodmare, :final_furlong)
      bronze = create(:legacy_horse, :broodmare, :final_furlong)
      silver = create(:legacy_horse, :broodmare, :final_furlong)
      gold = create(:legacy_horse, :broodmare, :final_furlong)
      platinum = create(:legacy_horse, :broodmare, :final_furlong)
  ...
  it "only returns horses owned by FF" do
    non_ff = create(:legacy_horse, :broodmare, Owner: 35)
    ff = create(:legacy_horse, :broodmare, :final_furlong)
  ...
  it "ignores already consigned horses" do
    already_consigned_1 = create(:legacy_horse, :broodmare, :final_furlong)
    already_con_1_horse = create(:horse, :broodmare, legacy_id: already_consigned_1.ID)
    create(:auction_horse, horse: already_con_1_horse)
    ff = create(:legacy_horse, :broodmare, :final_furlong)
    ff2 = create(:legacy_horse, :broodmare, :final_furlong)
