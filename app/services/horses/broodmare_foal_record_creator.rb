      ...
      if attrs[:born_foals_count].positive?
        ...
        if attrs[:raced_foals_count].positive?
          ...
          if attrs[:winning_foals_count].positive?
            ...
            if attrs[:stakes_winning_foals_count].positive?
          ...
          attrs[:total_foal_points] = Racing::LifetimeRaceRecord.where(horse_id: horse.foals.born.select(:id)).sum(:points)
          attrs[:total_foal_races] = Racing::LifetimeRaceRecord.where(horse_id: horse.foals.born.select(:id)).sum(:starts)
          attrs[:total_foal_earnings] = Racing::LifetimeRaceRecord.where(horse_id: horse.foals.born.select(:id)).sum(:earnings)
        end
      end
