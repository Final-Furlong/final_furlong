...
#  consigned_auction_uuid  :string(36)       indexed
#  last_modified           :datetime         not null, indexed
#  last_synced_to_rails_at :datetime         indexed
