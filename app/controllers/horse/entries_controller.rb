module Horse
  class EntriesController < ApplicationController
    ...
    def index
      @horse = Horses::Horse.includes(:manager, :racehorse_metadata, :race_qualification, :race_options, latest_race_result_finish: { race: { track_surface: :racetrack } }).find(params[:id])
