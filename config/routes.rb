...
# == Route Map
#
# I, [2024-04-03T16:03:11.252358 #64408]  INFO -- : [dotenv] Loaded [33m.env[0m
...
#                            motor_cable        /cable                                                  #<ActionCable::Server::Base:0x0000000109598210 @config=#<ActionCable::Server::Configuration:0x000000010959fe20 @log_tags=[], @connection_class=#<Proc:0x00000001074eee10 /Users/shanthi/.rbenv/versions/3.2.2/lib/ruby/gems/3.2.0/gems/actioncable-7.0.7.2/lib/action_cable/engine.rb:46 (lambda)>, @worker_pool_size=4, @disable_request_forgery_protection=false, @allow_same_origin_as_host=true, @logger=#<ActiveSupport::Logger:0x00000001083de240 @level=0, @progname=nil, @default_formatter=#<Logger::Formatter:0x000000010851fd98 @datetime_format=nil>, @formatter=#<Logger::Formatter:0x000000010851f9b0 @datetime_format=nil>, @logdev=#<Logger::LogDevice:0x00000001083de290 @shift_period_suffix=nil, @shift_size=nil, @shift_age=nil, @filename=nil, @dev=#<IO:<STDOUT>>, @binmode=false, @mon_data=#<Monitor:0x000000010851fcf8>, @mon_data_owner_object_id=14100>>, @cable={"adapter"=>"redis", "url"=>"redis://localhost:6379/1"}, @mount_path="/cable", @precompile_assets=true, @allowed_request_origins=/https?:\/\/localhost:\d+/>, @mutex=#<Monitor:0x00000001074e6300>, @pubsub=nil, @worker_pool=nil, @event_loop=nil, @remote_connections=nil>
