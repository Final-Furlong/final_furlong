RSpec.describe Horses::Broodmare::Shipment do
  describe "associations" do
    it { is_expected.to belong_to(:horse).class_name("Horses::Horse::Broodmare") }
  ...
  describe "#options_for_destination_select" do
    it "returns correct array" do # rubocop:disable RSpec/ExampleLength
      ...
      create_list(:stallion, 2, owner: stable_with_2_studs)

      stable_with_leased_stud = create(:stable, name: "D Stable")
      leaser = create(:stable, name: "A Stable")
      leased_stud = create(:stallion, owner: stable_with_leased_stud, manager: leaser)
