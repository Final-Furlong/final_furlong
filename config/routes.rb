...
# == Route Map
#
#   [1m[36mROM[postgres] (0.3ms)[0m  [1mSET standard_conforming_strings = ON[0m
#   [1m[35mROM[postgres] (0.6ms)[0m  SET client_min_messages = 'WARNING'
#   [1m[36mROM[postgres] (0.3ms)[0m  [1mSET DateStyle = 'ISO'[0m
#   [1m[35mROM[postgres] (19.6ms)[0m  SELECT CAST(current_setting('server_version_num') AS integer) AS v
#   [1m[36mROM[postgres] (4.7ms)[0m  [1mSELECT CAST("enumtypid" AS integer) AS "v", "enumlabel" FROM "pg_enum" ORDER BY "enumtypid", "enumsortorder"[0m
#   [1m[35mROM[postgres] (2.2ms)[0m  SELECT "typname", CAST("typarray" AS integer) AS "v" FROM "pg_type" WHERE (("oid" IN (54318, 54330, 54352, 54362, 54370, 55143)) AND ("typarray" != 0))
#   [1m[36mROM[postgres] (0.6ms)[0m  [1mSELECT "typarray", "oid" FROM "pg_type" WHERE ("typname" = 'horse_gender') LIMIT 1[0m
#   [1m[35mROM[postgres] (0.4ms)[0m  SELECT "typarray", "oid" FROM "pg_type" WHERE ("typname" = 'horse_status') LIMIT 1
#   [1m[36mROM[postgres] (0.6ms)[0m  [1mSELECT "typarray", "oid" FROM "pg_type" WHERE ("typname" = 'track_condition') LIMIT 1[0m
#   [1m[35mROM[postgres] (0.9ms)[0m  SELECT "typarray", "oid" FROM "pg_type" WHERE ("typname" = 'track_surface') LIMIT 1
#   [1m[36mROM[postgres] (0.5ms)[0m  [1mSELECT "typarray", "oid" FROM "pg_type" WHERE ("typname" = 'user_status') LIMIT 1[0m
#   [1m[35mROM[postgres] (0.4ms)[0m  SELECT "typarray", "oid" FROM "pg_type" WHERE ("typname" = 'horse_colour') LIMIT 1
...
#   [1m[35mROM[postgres] (1.1ms)[0m  SELECT CAST(current_setting('server_version_num') AS integer) AS v
#   [1m[36mROM[postgres] (2.7ms)[0m  [1mSELECT CAST("enumtypid" AS integer) AS "v", "enumlabel" FROM "pg_enum" ORDER BY "enumtypid", "enumsortorder"[0m
#   [1m[35mROM[postgres] (1.7ms)[0m  SELECT "typname", CAST("typarray" AS integer) AS "v" FROM "pg_type" WHERE (("oid" IN (54318, 54330, 54352, 54362, 54370, 55143)) AND ("typarray" != 0))
#   [1m[36mROM[postgres] (26.0ms)[0m  [1mSELECT "typarray", "oid" FROM "pg_type" WHERE ("typname" = 'horse_gender') LIMIT 1[0m
#   [1m[35mROM[postgres] (0.6ms)[0m  SELECT "typarray", "oid" FROM "pg_type" WHERE ("typname" = 'horse_status') LIMIT 1
#   [1m[36mROM[postgres] (0.5ms)[0m  [1mSELECT "typarray", "oid" FROM "pg_type" WHERE ("typname" = 'track_condition') LIMIT 1[0m
#   [1m[35mROM[postgres] (0.5ms)[0m  SELECT "typarray", "oid" FROM "pg_type" WHERE ("typname" = 'track_surface') LIMIT 1
#   [1m[36mROM[postgres] (0.5ms)[0m  [1mSELECT "typarray", "oid" FROM "pg_type" WHERE ("typname" = 'user_status') LIMIT 1[0m
#   [1m[35mROM[postgres] (0.4ms)[0m  SELECT "typarray", "oid" FROM "pg_type" WHERE ("typname" = 'horse_colour') LIMIT 1
#   [1m[36mROM[postgres] (13.3ms)[0m  [1mSELECT "pg_attribute"."attname" AS "name", CAST("pg_attribute"."atttypid" AS integer) AS "oid", CAST("basetype"."oid" AS integer) AS "base_oid", format_type("basetype"."oid", "pg_type"."typtypmod") AS "db_base_type", format_type("pg_type"."oid", "pg_attribute"."atttypmod") AS "db_type", pg_get_expr("pg_attrdef"."adbin", "pg_class"."oid") AS "default", NOT "pg_attribute"."attnotnull" AS "allow_null", COALESCE(("pg_attribute"."attnum" = ANY("pg_index"."indkey")), false) AS "primary_key", "pg_attribute"."attidentity", ("pg_attribute"."attgenerated" != '') AS "generated" FROM "pg_class" INNER JOIN "pg_attribute" ON ("pg_attribute"."attrelid" = "pg_class"."oid") INNER JOIN "pg_type" ON ("pg_type"."oid" = "pg_attribute"."atttypid") LEFT OUTER JOIN "pg_type" AS "basetype" ON ("basetype"."oid" = "pg_type"."typbasetype") LEFT OUTER JOIN "pg_attrdef" ON (("pg_attrdef"."adrelid" = "pg_class"."oid") AND ("pg_attrdef"."adnum" = "pg_attribute"."attnum")) LEFT OUTER JOIN "pg_index" ON (("pg_index"."indrelid" = "pg_class"."oid") AND ("pg_index"."indisprimary" IS TRUE)) WHERE (("pg_attribute"."attisdropped" IS FALSE) AND ("pg_attribute"."attnum" > 0) AND ("pg_class"."oid" = CAST(CAST('"racehorses"' AS regclass) AS oid))) ORDER BY "pg_attribute"."attnum"[0m
#   [1m[35mROM[postgres] (18.2ms)[0m  SELECT "indc"."relname" AS "name", "ind"."indisunique" AS "unique", "att"."attname" AS "column", "con"."condeferrable" AS "deferrable" FROM "pg_class" AS "tab" INNER JOIN "pg_index" AS "ind" ON ("ind"."indrelid" = "tab"."oid") INNER JOIN "pg_class" AS "indc" ON ("indc"."oid" = "ind"."indexrelid") INNER JOIN "pg_attribute" AS "att" ON (("att"."attrelid" = "tab"."oid") AND ("att"."attnum" = ANY("ind"."indkey"))) LEFT JOIN "pg_constraint" AS "con" ON ("con"."conname" = "indc"."relname") WHERE (("indc"."relkind" = 'i') AND ("ind"."indisprimary" IS FALSE) AND ("indexprs" IS NULL) AND ("indisvalid" IS TRUE) AND ("indisready" IS TRUE) AND ("indislive" IS TRUE) AND ("tab"."oid" = CAST(CAST('"racehorses"' AS regclass) AS oid)) AND ("indpred" IS NULL)) ORDER BY "indc"."relname", array_position("ind"."indkey", "att"."attnum")
#   [1m[36mROM[postgres] (5.8ms)[0m  [1mSELECT "co"."conname" AS "name", "att"."attname" AS "column", "co"."confupdtype" AS "on_update", "co"."confdeltype" AS "on_delete", "cl2"."relname" AS "table", "att2"."attname" AS "refcolumn", ("co"."condeferrable" AND "co"."condeferred") AS "deferrable", "nsp"."nspname" AS "schema" FROM "pg_constraint" AS "co" INNER JOIN "pg_class" AS "cl" ON ("cl"."oid" = "co"."conrelid") INNER JOIN "pg_attribute" AS "att" ON (("att"."attrelid" = "cl"."oid") AND ("att"."attnum" = ANY("co"."conkey"))) INNER JOIN "pg_class" AS "cl2" ON ("cl2"."oid" = "co"."confrelid") INNER JOIN "pg_attribute" AS "att2" ON (("att2"."attrelid" = "cl2"."oid") AND ("att2"."attnum" = ANY("co"."confkey"))) INNER JOIN "pg_namespace" AS "nsp" ON ("nsp"."oid" = "cl2"."relnamespace") WHERE (("cl"."relkind" IN ('r', 'p')) AND ("co"."contype" = 'f') AND (array_position("co"."conkey", "att"."attnum") = array_position("co"."confkey", "att2"."attnum")) AND ("cl"."oid" = CAST(CAST('"racehorses"' AS regclass) AS oid))) ORDER BY "co"."conname", array_position("co"."conkey", "att"."attnum")[0m
#   [1m[35mROM[postgres] (1.3ms)[0m  SELECT NULL AS "nil" FROM "racehorses" LIMIT 1
#   [1m[36mROM[postgres] (4.6ms)[0m  [1mSELECT "pg_attribute"."attname" AS "name", CAST("pg_attribute"."atttypid" AS integer) AS "oid", CAST("basetype"."oid" AS integer) AS "base_oid", format_type("basetype"."oid", "pg_type"."typtypmod") AS "db_base_type", format_type("pg_type"."oid", "pg_attribute"."atttypmod") AS "db_type", pg_get_expr("pg_attrdef"."adbin", "pg_class"."oid") AS "default", NOT "pg_attribute"."attnotnull" AS "allow_null", COALESCE(("pg_attribute"."attnum" = ANY("pg_index"."indkey")), false) AS "primary_key", "pg_attribute"."attidentity", ("pg_attribute"."attgenerated" != '') AS "generated" FROM "pg_class" INNER JOIN "pg_attribute" ON ("pg_attribute"."attrelid" = "pg_class"."oid") INNER JOIN "pg_type" ON ("pg_type"."oid" = "pg_attribute"."atttypid") LEFT OUTER JOIN "pg_type" AS "basetype" ON ("basetype"."oid" = "pg_type"."typbasetype") LEFT OUTER JOIN "pg_attrdef" ON (("pg_attrdef"."adrelid" = "pg_class"."oid") AND ("pg_attrdef"."adnum" = "pg_attribute"."attnum")) LEFT OUTER JOIN "pg_index" ON (("pg_index"."indrelid" = "pg_class"."oid") AND ("pg_index"."indisprimary" IS TRUE)) WHERE (("pg_attribute"."attisdropped" IS FALSE) AND ("pg_attribute"."attnum" > 0) AND ("pg_class"."oid" = CAST(CAST('"users"' AS regclass) AS oid))) ORDER BY "pg_attribute"."attnum"[0m
#   [1m[35mROM[postgres] (2.8ms)[0m  SELECT "indc"."relname" AS "name", "ind"."indisunique" AS "unique", "att"."attname" AS "column", "con"."condeferrable" AS "deferrable" FROM "pg_class" AS "tab" INNER JOIN "pg_index" AS "ind" ON ("ind"."indrelid" = "tab"."oid") INNER JOIN "pg_class" AS "indc" ON ("indc"."oid" = "ind"."indexrelid") INNER JOIN "pg_attribute" AS "att" ON (("att"."attrelid" = "tab"."oid") AND ("att"."attnum" = ANY("ind"."indkey"))) LEFT JOIN "pg_constraint" AS "con" ON ("con"."conname" = "indc"."relname") WHERE (("indc"."relkind" = 'i') AND ("ind"."indisprimary" IS FALSE) AND ("indexprs" IS NULL) AND ("indisvalid" IS TRUE) AND ("indisready" IS TRUE) AND ("indislive" IS TRUE) AND ("tab"."oid" = CAST(CAST('"users"' AS regclass) AS oid)) AND ("indpred" IS NULL)) ORDER BY "indc"."relname", array_position("ind"."indkey", "att"."attnum")
#   [1m[36mROM[postgres] (3.3ms)[0m  [1mSELECT "co"."conname" AS "name", "att"."attname" AS "column", "co"."confupdtype" AS "on_update", "co"."confdeltype" AS "on_delete", "cl2"."relname" AS "table", "att2"."attname" AS "refcolumn", ("co"."condeferrable" AND "co"."condeferred") AS "deferrable", "nsp"."nspname" AS "schema" FROM "pg_constraint" AS "co" INNER JOIN "pg_class" AS "cl" ON ("cl"."oid" = "co"."conrelid") INNER JOIN "pg_attribute" AS "att" ON (("att"."attrelid" = "cl"."oid") AND ("att"."attnum" = ANY("co"."conkey"))) INNER JOIN "pg_class" AS "cl2" ON ("cl2"."oid" = "co"."confrelid") INNER JOIN "pg_attribute" AS "att2" ON (("att2"."attrelid" = "cl2"."oid") AND ("att2"."attnum" = ANY("co"."confkey"))) INNER JOIN "pg_namespace" AS "nsp" ON ("nsp"."oid" = "cl2"."relnamespace") WHERE (("cl"."relkind" IN ('r', 'p')) AND ("co"."contype" = 'f') AND (array_position("co"."conkey", "att"."attnum") = array_position("co"."confkey", "att2"."attnum")) AND ("cl"."oid" = CAST(CAST('"users"' AS regclass) AS oid))) ORDER BY "co"."conname", array_position("co"."conkey", "att"."attnum")[0m
#   [1m[35mROM[postgres] (25.8ms)[0m  SELECT NULL AS "nil" FROM "users" LIMIT 1
