class MigrateLegacyRacetrackService
  def call # rubocop:disable Metrics/AbcSize, Metrics/MethodLength
    arlington = Location.find_or_create_by(name: 'Arlington Heights, IL', state: 'Illinois', country: 'USA')
    track = Racetrack.find_or_create_by(name: 'Arlington', location: arlington, latitude: 42.093345, longitude: -88.010049)
    TrackSurface.find_or_create_by(
    ...
    track = Racetrack.find_or_create_by(name: 'Aqueduct', location: aqueduct, latitude: 40.672672402365784, longitude: -73.83568944359783)
    TrackSurface.find_or_create_by(
    ...
    track = Racetrack.find_or_create_by(name: 'Belmont', location: belmont, latitude: 40.714097026488375, longitude: -73.72339058827338)
    TrackSurface.find_or_create_by(
    ...
    track = Racetrack.find_or_create_by(name: 'Churchill Downs', location: churchill, latitude: 38.203952813579676, longitude: -85.77244171716885)
    TrackSurface.find_or_create_by(
    ...
    track = Racetrack.find_or_create_by(name: 'Del Mar', location: del_mar, latitude: 32.97584488996692, longitude: -117.26137280194155)
    TrackSurface.find_or_create_by(
    ...
    track = Racetrack.find_or_create_by(name: 'Gulfstream', location: gulfstream, latitude: 25.978296858838124, longitude: -80.13959415974179)
    TrackSurface.find_or_create_by(
    ...
    track = Racetrack.find_or_create_by(name: 'Santa Anita', location: santa_anita, latitude: 34.13943486041334, longitude: -118.04526764424672)
    TrackSurface.find_or_create_by(
    ...
    track = Racetrack.find_or_create_by(name: 'Fort Erie', location: fort_erie, latitude: 42.91719773636638, longitude: -78.93430161520584)
    TrackSurface.find_or_create_by(
    ...
    track = Racetrack.find_or_create_by(name: 'Pimlico', location: pimlico, latitude: 39.35239671481957, longitude: -76.67455350364794)
    TrackSurface.find_or_create_by(
    ...
    track = Racetrack.find_or_create_by(name: 'Saratoga', location: saratoga, latitude: 43.07417424394634, longitude: -73.76801208821416)
    TrackSurface.find_or_create_by(
    ...
    track = Racetrack.find_or_create_by(name: 'Woodbine', location: woodbine, latitude: 43.71462041867901, longitude: -79.60417244586846)
    TrackSurface.find_or_create_by(
    ...
    track = Racetrack.find_or_create_by(name: 'Calder', location: calder, latitude: 25.967445634496652, longitude: -80.24275048672962)
    TrackSurface.find_or_create_by(
    ...
    track = Racetrack.find_or_create_by(name: 'Lone Star Park', location: lone_star, latitude: 32.77226468229383, longitude: -96.9886994019458)
    TrackSurface.find_or_create_by(
    ...
    track = Racetrack.find_or_create_by(name: 'Australia', location: australia, latitude: -37.79077497446637, longitude: 144.9118480828217)
    TrackSurface.find_or_create_by(
    ...
    track = Racetrack.find_or_create_by(name: 'Dubai', location: dubai, latitude: 25.159249825824272, longitude: 55.301946411409446)
    TrackSurface.find_or_create_by(
    ...
    track = Racetrack.find_or_create_by(name: 'England', location: england, latitude: 51.38085777036567, longitude: -0.2770522107837388)
    TrackSurface.find_or_create_by(
      racetrack: track, width: 80, length: 10560, turn_to_finish_length: 1980, turn_distance: 2310, banking: 4)
    TrackSurface.find_or_create_by(
      racetrack: track, surface: 'turf', width: 80, length: 10560, turn_to_finish_length: 1980, turn_distance: 2310,
      banking: 5)
    TrackSurface.find_or_create_by(
      racetrack: track, surface: 'steeplechase', width: 80, length: 10560, turn_to_finish_length: 1980,
      turn_distance: 2310, banking: 5, jumps: 10)

    ireland = Location.find_or_create_by(name: 'Loughbrown', state: 'Kildare', country: 'Ireland')
    track = Racetrack.find_or_create_by(name: 'Ireland', location: ireland, latitude: 53.16852191180491, longitude: -6.843204036496443)
    TrackSurface.find_or_create_by(
      racetrack: track, width: 80, length: 10560, turn_to_finish_length: 1980, turn_distance: 2310, banking: 4)
    TrackSurface.find_or_create_by(
      racetrack: track, surface: 'turf', width: 80, length: 10560, turn_to_finish_length: 1980, turn_distance: 2310,
    ...
    track = Racetrack.find_or_create_by(name: 'Hong Kong', location: hong_kong, latitude: 22.406066419054742, longitude: 114.20210443057607)
    TrackSurface.find_or_create_by(
      racetrack: track, surface: 'turf', width: 66, length: 7218, turn_to_finish_length: 1968, turn_distance: 1548,
      banking: 4)

    japan = Location.find_or_create_by(name: 'Tokyo', country: 'Japan')
    track = Racetrack.find_or_create_by(name: 'Japan', location: japan, latitude: 35.66268118640489, longitude: 139.48578704050234)
    TrackSurface.find_or_create_by(
      racetrack: track, width: 66, length: 7218, turn_to_finish_length: 1968, turn_distance: 1548, banking: 2)
    TrackSurface.find_or_create_by(
      racetrack: track, surface: 'turf', width: 66, length: 7218, turn_to_finish_length: 1968, turn_distance: 1548,
    ...
    track = Racetrack.find_or_create_by(name: 'France', location: france, latitude: 48.858952587447526, longitude: 2.229643527283667)
    TrackSurface.find_or_create_by(
    ...
    track = Racetrack.find_or_create_by(name: 'Final Furlong', location: ff, latitude: 38.047171353962845, longitude: -84.60626185950164)
    TrackSurface.find_or_create_by(
