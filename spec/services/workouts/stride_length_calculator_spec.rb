describe Workouts::StrideLengthCalculator do
  ...
  describe "#call" do
      ...
      it "is correct" do
        100.times do |n|
          calculator = described_class.new(
            activity: "walk", stride_length: 0, effort: n, weight: weight_modifier, equipment_status:,
    ...
    context "when trotting" do
      it "is correct" do
        100.times do |n|
          calculator = described_class.new(
            activity: "trot", stride_length: 0, effort: n, weight: weight_modifier, equipment_status:,
            track_preference:, track_condition:, consistency:
          )
    ...
    context "when jogging" do
      it "is correct" do
        100.times do |n|
          calculator = described_class.new(
            activity: "jog", stride_length: 0, effort: n, weight: weight_modifier, equipment_status:,
            track_preference:, track_condition:, consistency:
          )
          min_value = 48 * (n / 100) * weight_modifier * equipment_status * track_preference * track_condition * consistency
          max_value = 84 * (n / 100) * weight_modifier * equipment_status * track_preference * track_condition * consistency
    ...
    context "when cantering" do
      it "is correct" do
        100.times do |n|
          calculator = described_class.new(
            activity: "canter", stride_length: 0, effort: n, weight: weight_modifier, equipment_status:,
            track_preference:, track_condition:, consistency:
          )
    ...
    context "when galloping" do
      it "is correct" do
        100.times do |n|
          calculator = described_class.new(
            activity: "gallop", stride_length: 100, effort: n, weight: weight_modifier, equipment_status:,
            track_preference:, track_condition:, consistency:
          )
    ...
    context "when breezing" do
      it "is correct" do
        100.times do |n|
          calculator = described_class.new(
            activity: "breeze", stride_length: 100, effort: n, weight: weight_modifier, equipment_status:,
            track_preference:, track_condition:, consistency:
          )
          min_value = 89 * (n / 100) * weight_modifier * equipment_status * track_preference * track_condition * consistency
          max_value = 99 * (n / 100) * weight_modifier * equipment_status * track_preference * track_condition * consistency
    ...
    context "when other activity" do
      it "raises error" do
        calculator = described_class.new(
          activity: "grazing", stride_length: 0, effort: 100, weight: weight_modifier, equipment_status:,
          track_preference:, track_condition:, consistency:
        )
    ...
    context "when invalid effort" do
      it "raises error" do
        expect do
          described_class.new(activity: "walk", stride_length: 0, effort: 1000, weight: weight_modifier, equipment_status:,
            track_preference:, track_condition:, consistency:)
    ...
    context "when invalid weight modifier" do
      it "raises error" do
        expect do
          described_class.new(activity: "walk", stride_length: 0, effort: 100, weight: 3.0, equipment_status:,
            track_preference:, track_condition:, consistency:)
    ...
    context "when invalid track preference" do
      it "raises error" do
        expect do
          described_class.new(activity: "walk", stride_length: 0, effort: 100, weight: weight_modifier, equipment_status:,
