module Horses
  class HorsesController < ApplicationController
    ...
    # @route GET /horses (horses_horses)
    ...
    # @route GET /horses/:id (horses_horse)
    def show; end

    # @route GET /horses/:id/edit (edit_horses_horse)
    def edit; end

    # @route PATCH /horses/:id (horses_horse)
    # @route PUT /horses/:id (horses_horse)
    def update
      if @horse.update(horse_params)
        @horse.reload
        respond_to do |format|
          format.html { redirect_to horses_path, notice: t("horses.update.success", name: @horse.name) }
          format.turbo_stream { flash.now[:success] = t("horses.update.success", name: @horse.name) }
        end
      else
