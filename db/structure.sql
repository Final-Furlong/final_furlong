...
CREATE TABLE public.eclipse_awards (
    ...
    awardable_id bigint,
    year integer DEFAULT 0 NOT NULL,
    category public.eclipse_award_categories,
    created_at timestamp(6) with time zone NOT NULL,
    updated_at timestamp(6) with time zone NOT NULL
);
...
--
-- Name: index_eclipse_awards_on_awardable; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_eclipse_awards_on_awardable ON public.eclipse_awards USING btree (awardable_type, awardable_id);


--
-- Name: index_eclipse_awards_on_awardable_type_and_awardable_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_eclipse_awards_on_awardable_type_and_awardable_id ON public.eclipse_awards USING btree (awardable_type, awardable_id);


--
-- Name: index_eclipse_awards_on_year; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_eclipse_awards_on_year ON public.eclipse_awards USING btree (year);
