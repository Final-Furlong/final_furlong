...
#  first_jockey_id                                :bigint           uniquely indexed => [second_jockey_id, third_jockey_id], uniquely indexed => [horse_id, second_jockey_id, third_jockey_id], indexed
#  horse_id                                       :bigint           not null, uniquely indexed => [first_jockey_id, second_jockey_id, third_jockey_id], uniquely indexed
#  second_jockey_id                               :bigint           uniquely indexed => [first_jockey_id, third_jockey_id], uniquely indexed => [horse_id, first_jockey_id, third_jockey_id], indexed
#  third_jockey_id                                :bigint           uniquely indexed => [first_jockey_id, second_jockey_id], uniquely indexed => [horse_id, first_jockey_id, second_jockey_id], indexed
#
# Indexes
#
#  idx_on_first_jockey_id_second_jockey_id_third_jocke_d5a50ca7c3  (first_jockey_id,second_jockey_id,third_jockey_id) UNIQUE
