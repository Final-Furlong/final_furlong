RSpec.describe Racing::RaceResultHorse do
  describe "associations" do
    ...
    it { is_expected.to belong_to(:jockey).class_name("Racing::Jockey").optional.inverse_of(:race_result_horses) }
    it { is_expected.to belong_to(:odd).class_name("Racing::Odd").optional.inverse_of(:race_result_horses) }
  end
end
