class MigrateLegacyRacetrackService # rubocop:disable Metrics/ClassLength
  def call # rubocop:disable Metrics/AbcSize, Metrics/MethodLength
    ...
    track = Racetrack.find_or_create_by(name: "Arlington", location: arlington, latitude: 42.093345,
                                        longitude: -88.010049)
    ...
    track = Racetrack.find_or_create_by(name: "Aqueduct", location: aqueduct, latitude: 40.672672402365784,
    ...
    track = Racetrack.find_or_create_by(name: "Belmont", location: belmont, latitude: 40.714097026488375,
    ...
    track = Racetrack.find_or_create_by(name: "Churchill Downs", location: churchill, latitude: 38.203952813579676,
    ...
    track = Racetrack.find_or_create_by(name: "Del Mar", location: del_mar, latitude: 32.97584488996692,
    ...
    track = Racetrack.find_or_create_by(name: "Gulfstream", location: gulfstream, latitude: 25.978296858838124,
    ...
    track = Racetrack.find_or_create_by(name: "Santa Anita", location: santa_anita, latitude: 34.13943486041334,
    ...
    track = Racetrack.find_or_create_by(name: "Fort Erie", location: fort_erie, latitude: 42.91719773636638,
    ...
    track = Racetrack.find_or_create_by(name: "Pimlico", location: pimlico, latitude: 39.35239671481957,
    ...
    track = Racetrack.find_or_create_by(name: "Saratoga", location: saratoga, latitude: 43.07417424394634,
    ...
    track = Racetrack.find_or_create_by(name: "Woodbine", location: woodbine, latitude: 43.71462041867901,
    ...
    track = Racetrack.find_or_create_by(name: "Calder", location: calder, latitude: 25.967445634496652,
    ...
    track = Racetrack.find_or_create_by(name: "Lone Star Park", location: lone_star, latitude: 32.77226468229383,
    ...
    track = Racetrack.find_or_create_by(name: "Australia", location: australia, latitude: -37.79077497446637,
    ...
    track = Racetrack.find_or_create_by(name: "Dubai", location: dubai, latitude: 25.159249825824272,
    ...
    track = Racetrack.find_or_create_by(name: "England", location: england, latitude: 51.38085777036567,
    ...
    track = Racetrack.find_or_create_by(name: "Ireland", location: ireland, latitude: 53.16852191180491,
    ...
    track = Racetrack.find_or_create_by(name: "Hong Kong", location: hong_kong, latitude: 22.406066419054742,
    ...
    track = Racetrack.find_or_create_by(name: "Japan", location: japan, latitude: 35.66268118640489,
    ...
    track = Racetrack.find_or_create_by(name: "France", location: france, latitude: 48.858952587447526,
    ...
    track = Racetrack.find_or_create_by(name: "Final Furlong", location: ff, latitude: 38.047171353962845,
