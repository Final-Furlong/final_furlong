...
class User
  ...
  module GeneratedAssociationMethods
    sig { params(args: T.untyped, blk: T.untyped).returns(::Stable) }
    def build_stable(*args, &blk); end

    sig { params(args: T.untyped, blk: T.untyped).returns(::Stable) }
    def create_stable(*args, &blk); end
    ...
    sig { params(value: T.nilable(::Stable)).void }
  ...
  module GeneratedAttributeMethods
    ...
    sig { returns(T::Boolean) }
    def discourse_id_previously_changed?; end
    ...
    sig { returns(T::Boolean) }
    def will_save_change_to_discourse_id?; end
