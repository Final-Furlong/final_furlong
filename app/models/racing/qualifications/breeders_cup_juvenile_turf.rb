module Racing::Qualifications
  class BreedersCupJuvenileTurf < ApplicationRecord
    include BreedersCupQualifiable

    self.table_name = "breeders_cup_juvenile_turf_qualifiers"

    belongs_to :horse, class_name: "Horses::Horse::Racehorse", inverse_of: :breeders_cup_juvenile_turf_qualification
  end
end

# == Schema Information
#
# Table name: breeders_cup_juvenile_turf_qualifiers
...
#  index_breeders_cup_juvenile_turf_qualifiers_on_stakes_thirds   (stakes_thirds)
#  index_breeders_cup_juvenile_turf_qualifiers_on_stakes_wins     (stakes_wins)
#
