ActiveRecordDoctor.configure do
  ...
  detector :missing_presence_validation,
    ignore_attributes: [
      ...
      "Horses::BreedingStats.soundness",
  ...
  detector :missing_foreign_keys,
    ignore_associations: [
      ...
      "Racing::Qualifications::BreedersSeries2yoDirt.horse",
      "Racing::Qualifications::BreedersSeries2yoFilliesDirt.horse",
      "Racing::Qualifications::BreedersSeries2yoFilliesTurf.horse",
      "Racing::Qualifications::BreedersSeries2yoTurf.horse",
      "Racing::Qualifications::BreedersSeries3yoDirt.horse",
      "Racing::Qualifications::BreedersSeries3yoFilliesDirt.horse",
      "Racing::Qualifications::BreedersSeries3yoFilliesTurf.horse",
      "Racing::Qualifications::BreedersSeries3yoTurf.horse",
      "Racing::Qualifications::BreedersSeries4yoDirt.horse",
      "Racing::Qualifications::BreedersSeries4yoMaresDirt.horse",
      "Racing::Qualifications::BreedersSeries4yoMaresTurf.horse",
