...
CREATE TABLE `ff_admin` (
                            `ID` int NOT NULL AUTO_INCREMENT,
                            `Members` smallint NOT NULL DEFAULT '75',
                            `StartingHorses` tinyint NOT NULL DEFAULT '1',
                            `StartingBudget` mediumint NOT NULL DEFAULT '0',
                            `SatDeadline` date DEFAULT NULL,
                            `WedDeadline` date DEFAULT NULL,
                            `EFUpdate` date NOT NULL,
                            `RacerLimit` smallint NOT NULL DEFAULT '25',
                            `StudLimit` smallint NOT NULL DEFAULT '5',
                            `BroodmareLimit` smallint NOT NULL DEFAULT '25',
                            `YearlingLimit` tinyint NOT NULL DEFAULT '0',
                            `WeanlingLimit` tinyint NOT NULL DEFAULT '0',
                            `HorseLimit` smallint NOT NULL DEFAULT '150',
...
CREATE TABLE `ff_auctionbids` (
                                  `ID` int NOT NULL AUTO_INCREMENT,
                                  `Auction` smallint NOT NULL DEFAULT '0',
                                  `Horse` mediumint NOT NULL DEFAULT '0',
                                  `Bidder` smallint NOT NULL DEFAULT '0',
...
CREATE TABLE `ff_auctions` (
                               ...
                               `Auctioneer` smallint NOT NULL DEFAULT '0',
...
CREATE TABLE `ff_colorwar` (
    ...
    `PtsAvail` smallint NOT NULL DEFAULT '0',
    PRIMARY KEY (`ID`)
...
CREATE TABLE `ff_distinct_errors` (
    ...
    `error_line` mediumint DEFAULT NULL
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
...
CREATE TABLE `ff_foalrecords` (
    ...
    `Stakes` smallint NOT NULL DEFAULT '0',
    `Wins` smallint NOT NULL DEFAULT '0',
    `StakesWn` smallint NOT NULL DEFAULT '0',
    `Seconds` smallint NOT NULL DEFAULT '0',
    `StakesSds` smallint NOT NULL DEFAULT '0',
    `Thirds` smallint NOT NULL DEFAULT '0',
    `StakesTds` smallint NOT NULL DEFAULT '0',
    `Fourths` smallint NOT NULL DEFAULT '0',
    `StakesFs` smallint NOT NULL DEFAULT '0',
    `Points` smallint NOT NULL DEFAULT '0',
...
CREATE TABLE `ff_futureshipping` (
                                     `ID` int NOT NULL AUTO_INCREMENT,
                                     `Horse` mediumint NOT NULL,
                                     `ToTrack` smallint DEFAULT NULL,
                                     `ToFarm` smallint DEFAULT NULL,
                                     `Mode` enum('R','A','*') CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL DEFAULT 'R' COMMENT '* = choose best method',
    `Date` date NOT NULL,
    `RaceLink` smallint DEFAULT NULL,
...
CREATE TABLE `ff_horse_brankings` (
                                      ...
                                      `Points` smallint NOT NULL DEFAULT '0',
                                      `Foals` smallint NOT NULL DEFAULT '0',
                                      `Races` int NOT NULL,
                                      PRIMARY KEY (`Horse`),
...
CREATE TABLE `ff_horse_jockeys` (
                                    `ID` int NOT NULL AUTO_INCREMENT,
                                    `Horse` mediumint NOT NULL DEFAULT '0',
                                    `Jockey` smallint NOT NULL DEFAULT '0',
...
CREATE TABLE `ff_horse_sales` (
                                  ...
                                  `Horse` mediumint NOT NULL,
                                  `Date` date NOT NULL,
                                  `Seller` smallint DEFAULT NULL,
                                  `Buyer` smallint DEFAULT NULL,
                                  `Price` mediumint DEFAULT NULL,
...
CREATE TABLE `ff_horse_shipping` (
                                     ...
                                     `FromTrack` smallint DEFAULT NULL,
                                     `ToTrack` smallint DEFAULT NULL,
                                     `FromFarm` smallint DEFAULT NULL,
                                     `ToFarm` smallint DEFAULT NULL,
...
CREATE TABLE `ff_horses` (
    ...
    `Location` smallint NOT NULL DEFAULT '59',
    `Boarded` tinyint(1) NOT NULL DEFAULT '0',
    `InTransit` tinyint(1) NOT NULL DEFAULT '0',
    `Owner` smallint DEFAULT NULL,
    `Leased` tinyint(1) NOT NULL DEFAULT '0',
    `Breeder` smallint DEFAULT NULL,
    `LocBred` smallint NOT NULL DEFAULT '10',
    ...
    `SellTo` smallint DEFAULT '0',
    `StudPrice` mediumint DEFAULT '-1',
    ...
    `Break` smallint DEFAULT NULL,
    `Min` smallint DEFAULT NULL,
    `Ave` smallint DEFAULT NULL,
    ...
    `Pissy` smallint DEFAULT NULL,
    `Ratability` smallint DEFAULT NULL,
    `Equipment` tinyint DEFAULT NULL,
    `DefaultEquip` tinyint DEFAULT NULL,
    `DefaultJock1` smallint DEFAULT NULL,
    `DefaultJock2` smallint DEFAULT NULL,
    `DefaultJock3` smallint DEFAULT NULL,
    `DefaultInstructions` tinyint DEFAULT NULL,
    `DefaultWorkoutTrack` smallint DEFAULT NULL,
    `EnergyMin` tinyint DEFAULT NULL,
    `SPS` double(5,3) DEFAULT NULL,
    `LoafThresh` smallint DEFAULT NULL,
    `LoafStride` smallint DEFAULT NULL,
    `LoafPct` tinyint NOT NULL DEFAULT '0',
    `Acceleration` smallint DEFAULT NULL,
    `Traffic` smallint DEFAULT NULL,
    `EnergyRegain` tinyint DEFAULT NULL,
    `EnergyCurrent` mediumint DEFAULT NULL,
...
CREATE TABLE `ff_hoty_winners` (
                                   ...
                                   `Year` smallint NOT NULL DEFAULT '0',
                                   `Category` tinyint NOT NULL DEFAULT '0',
                                   `Winner` mediumint NOT NULL DEFAULT '0',
                                   PRIMARY KEY (`ID`),
...
CREATE TABLE `ff_jockeys` (
    ...
    `Break` smallint NOT NULL DEFAULT '0',
    `Min` smallint NOT NULL DEFAULT '0',
    `Ave` smallint NOT NULL DEFAULT '0',
    ...
    `Turning` smallint NOT NULL DEFAULT '0',
    `Strength` tinyint NOT NULL DEFAULT '0',
    `Looking` tinyint NOT NULL DEFAULT '0',
    `WhipSec` smallint NOT NULL DEFAULT '0',
...
CREATE TABLE `ff_nom_bs` (
                             `ID` int NOT NULL AUTO_INCREMENT,
                             `Stable` smallint NOT NULL DEFAULT '0',
...
CREATE TABLE `ff_nominations` (
                                  `ID` int NOT NULL AUTO_INCREMENT,
                                  `Race` mediumint NOT NULL DEFAULT '0',
                                  `Horse` mediumint NOT NULL DEFAULT '0',
...
CREATE TABLE `ff_nomraces` (
                               ...
                               `Weanling` mediumint unsigned DEFAULT NULL,
                               `Yearling` mediumint unsigned DEFAULT NULL,
                               `2yo` mediumint unsigned DEFAULT NULL,
                               `3yo` mediumint unsigned DEFAULT NULL,
                               `3yo+` mediumint unsigned DEFAULT NULL,
                               `4yo+` mediumint unsigned DEFAULT NULL,
...
CREATE TABLE `ff_raceentries` (
                                  ...
                                  `Jockey` smallint DEFAULT NULL,
                                  `Jock2` smallint DEFAULT NULL,
                                  `Jock3` smallint DEFAULT NULL,
                                  `Instructions` tinyint DEFAULT NULL,
...
CREATE TABLE `ff_speedrecords` (
                                   `ID` int NOT NULL AUTO_INCREMENT,
                                   `RaceID` mediumint NOT NULL DEFAULT '0',
...
CREATE TABLE `ff_stablerrs` (
                                `ID` int NOT NULL AUTO_INCREMENT,
                                `Stable` mediumint NOT NULL DEFAULT '0',
                                `Year` smallint DEFAULT NULL,
                                `Races` smallint NOT NULL DEFAULT '0',
                                `stakes` smallint NOT NULL DEFAULT '0',
                                `Win` smallint NOT NULL DEFAULT '0',
                                `stakeswin` smallint NOT NULL DEFAULT '0',
                                `Place` smallint NOT NULL DEFAULT '0',
                                `stakesplace` smallint NOT NULL DEFAULT '0',
                                `Shows` smallint NOT NULL DEFAULT '0',
                                `stakesshow` smallint NOT NULL DEFAULT '0',
                                `Fourth` smallint NOT NULL DEFAULT '0',
                                `stakesfourth` smallint NOT NULL DEFAULT '0',
...
CREATE TABLE `ff_users` (
    ...
    `ForumID` smallint DEFAULT NULL,
    `BugID` int DEFAULT NULL,
    `Email` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
    `Admin` tinyint(1) NOT NULL DEFAULT '0',
    `TrackID` smallint DEFAULT NULL,
    `TrackMiles` tinyint DEFAULT NULL,
    `RefID` mediumint NOT NULL DEFAULT '0',
...
CREATE TABLE `ff_visitors_log` (
                                   `ID` int NOT NULL AUTO_INCREMENT,
                                   `Date` date NOT NULL,
                                   `Visitors` smallint NOT NULL DEFAULT '0',
                                   PRIMARY KEY (`ID`)
...
CREATE TABLE `horse_parents_mv` (
                                    `horse_id` int unsigned NOT NULL AUTO_INCREMENT,
                                    `foal_count` smallint NOT NULL DEFAULT '0',
                                    `racers_count` smallint NOT NULL DEFAULT '0',
                                    `winners_count` smallint NOT NULL DEFAULT '0',
                                    `titled_horses_count` smallint NOT NULL DEFAULT '0',
                                    `stakes_winners_count` smallint NOT NULL DEFAULT '0',
                                    `multi_stakes_winners_count` smallint NOT NULL DEFAULT '0',
                                    `millionaires_count` smallint NOT NULL DEFAULT '0',
                                    `total_foal_earnings` bigint NOT NULL DEFAULT '0',
                                    `dirt_runners_count` smallint NOT NULL DEFAULT '0',
                                    `dirt_otb_count` smallint NOT NULL DEFAULT '0',
                                    `dirt_level` smallint NOT NULL DEFAULT '0',
                                    `dirt_level_text` varchar(40) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT 'Maiden',
    `turf_runners_count` smallint NOT NULL DEFAULT '0',
    `turf_otb_count` smallint NOT NULL DEFAULT '0',
    `turf_level` smallint NOT NULL DEFAULT '0',
    `turf_level_text` varchar(40) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT 'Maiden',
    `sc_runners_count` smallint NOT NULL DEFAULT '0',
    `sc_otb_count` smallint NOT NULL DEFAULT '0',
    `sc_level` smallint NOT NULL DEFAULT '0',
    `sc_level_text` varchar(40) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT 'Maiden',
    `sprinters_count` smallint NOT NULL DEFAULT '0',
    `sprinters_otb_count` smallint NOT NULL DEFAULT '0',
    `sprinters_level` smallint NOT NULL DEFAULT '0',
    `sprinters_level_text` varchar(40) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT 'Maiden',
    `classic_count` smallint NOT NULL DEFAULT '0',
    `classic_otb_count` smallint NOT NULL DEFAULT '0',
    `classic_level` smallint NOT NULL DEFAULT '0',
    `classic_level_text` varchar(40) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT 'Maiden',
    `endurance_count` smallint NOT NULL DEFAULT '0',
    `endurance_otb_count` smallint NOT NULL DEFAULT '0',
    `endurance_level` smallint NOT NULL DEFAULT '0',
    `endurance_level_text` varchar(40) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT 'Maiden',
    `fast_runners_count` smallint NOT NULL DEFAULT '0',
    `fast_otb_count` smallint NOT NULL DEFAULT '0',
    `fast_level` smallint NOT NULL DEFAULT '0',
    `fast_level_text` varchar(40) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT 'Maiden',
    `good_runners_count` smallint NOT NULL DEFAULT '0',
    `good_otb_count` smallint NOT NULL DEFAULT '0',
    `good_level` smallint NOT NULL DEFAULT '0',
    `good_level_text` varchar(40) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT 'Maiden',
    `wet_runners_count` smallint NOT NULL DEFAULT '0',
    `wet_otb_count` smallint NOT NULL DEFAULT '0',
    `wet_level` smallint NOT NULL DEFAULT '0',
    `wet_level_text` varchar(40) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT 'Maiden',
    `slow_runners_count` smallint NOT NULL DEFAULT '0',
    `slow_otb_count` smallint NOT NULL DEFAULT '0',
    `slow_level` smallint NOT NULL DEFAULT '0',
...
CREATE TABLE `horse_racehorses_mv` (
    ...
    `default_jockey` smallint DEFAULT NULL,
    `second_jockey` smallint DEFAULT NULL,
    `third_jockey` smallint DEFAULT NULL,
    `riding_instructions` smallint DEFAULT NULL,
    `wins_count` int NOT NULL DEFAULT '0',
    `allowance_wins_count` int NOT NULL DEFAULT '0',
    `last_race_id` int DEFAULT NULL,
    `last_race_finishers` smallint DEFAULT NULL,
    `races_count` smallint NOT NULL DEFAULT '0',
    `rest_days_count` smallint NOT NULL DEFAULT '0',
...
CREATE TABLE `horse_training_schedules_mv` (
    ...
    `default_workout_track` smallint DEFAULT NULL,
