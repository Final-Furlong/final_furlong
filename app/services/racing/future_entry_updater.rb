module Racing
  class FutureEntryUpdater
    attr_reader :entry, :race, :horse, :ship_date

    def update_entry(entry:, stable:, first_jockey: nil, second_jockey: nil, third_jockey: nil,
    ...
    class Result
      ...
      def initialize(entry:, wreated: false, error: nil)
        @entry = entry
        @updated = updated
        @error = error
      end
