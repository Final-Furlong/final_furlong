...
ActiveRecord::Schema[7.0].define(version: 2022_07_21_204945) do
  ...
  create_table "new_activations", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.uuid "user_id"
    t.string "token", null: false
    t.datetime "activated_at"
    t.datetime "created_at", null: false
  ...
  create_table "new_horses", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.string "name"
    t.string "gender", null: false, comment: "colt, filly, mare, stallion, gelding"
    t.enum "status", default: "unborn", null: false, comment: "unborn, weanling, yearling, racehorse, broodmare, stud, retired, retired_broodmare, retired_stud, deceased", enum_type: "horse_status"
    t.date "date_of_birth", null: false
  ...
  create_table "new_racetracks", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
  ...
  create_table "new_stables", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.string "name", null: false
    t.uuid "user_id"
    t.integer "legacy_id"
    t.text "description"
  ...
  create_table "new_users", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
