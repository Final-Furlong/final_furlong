...
--
-- Name: idx_on_horse_id_year_43238ad949; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX idx_on_horse_id_year_43238ad949 ON public.supplemental_breeders_cup_nominations USING btree (horse_id, year);
...
--
-- Name: index_breeders_cup_nominations_on_horse_id_and_race_id; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX index_breeders_cup_nominations_on_horse_id_and_race_id ON public.breeders_cup_nominations USING btree (horse_id, race_id) WHERE (race_id IS NOT NULL);


--
-- Name: index_breeders_cup_nominations_on_race_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_breeders_cup_nominations_on_race_id ON public.breeders_cup_nominations USING btree (race_id);
...
--
-- Name: breeders_cup_nominations fk_rails_0bc308218a; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.breeders_cup_nominations
    ADD CONSTRAINT fk_rails_0bc308218a FOREIGN KEY (race_id) REFERENCES public.race_schedules(id);
